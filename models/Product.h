...
class Product
{
  public:
    ...
    /**  For column cost  */
    ///Get the value of the column cost, returns the default value if the column is null
    const std::string &getValueOfCost() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCost() const noexcept;
    ///Set the value of the column cost
    void setCost(const std::string &pCost) noexcept;
    void setCost(std::string &&pCost) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> cost_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where product_id = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where product_id = $1";
        return sql;
    }
